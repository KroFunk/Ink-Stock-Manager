...
<tr style='background-color:#666; color:#eee;'><td>Make/Model</td><td>Media</td><td>Colour</td><td>Type</td><td>Room - Department</td><td width="60px">Restore</td><td width="60px"><center>Delete</center></td><td width="30px">Edit</td><td width="60px" >Support</td><td width="50px">History</td><td width="40px">Stock</td></tr>
</table>
</div>
...
?>
<div class='HeaderBanner'>Printers (deleted) <img src="../icns/question.png" /><div id="SubHeader" class='SubHeaderBanner'>Loading, please wait...</div></div>
...
<a class="function refresh" href="index.php"><img src="../icns/refresh.png"/> View current printers</a>
</div>
...
$result = mysqli_query($con, "SELECT * FROM Printers WHERE `Deleted` = 1;");
...
$rooms = mysqli_query($con, "SELECT * FROM `Departments` WHERE `Departments`.`PID` = $PID ORDER BY `Room` ASC;");
  ...
  echo "</td>
  <td><center><a href='" . 'javascript:openwrapper("restoreprinter.php?index=' .  $row['PID'] . '&printer=' . $row['PrinterMake'] . " " . $row['PrinterModel'] . '", 920, 400)' . "'><img src='../icns/delete.png'/></a></center></td>
  <td><center><a href='" . 'javascript:openwrapper("dropprinter.php?index=' .  $row['PID'] . '&printer=' . $row['PrinterMake'] . " " . $row['PrinterModel'] . '", 920, 400)' . "'><img src='../icns/delete.png'/></a></center></td>
